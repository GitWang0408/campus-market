 ...
 */
@Entity
@Table(name="task_ylrc_wanted_goods")
@EntityListeners(AuditingEntityListener.class)
public class task_WantedGoods extends BaseEntity{
	...
	public String toString() {
		return "task_WantedGoods [student=" + student + ", name=" + name + ", sellPrice=" + sellPrice + ", tradePlace="
				+ tradePlace + ", content=" + content + ", viewNumber=" + viewNumber + "]";
	}
